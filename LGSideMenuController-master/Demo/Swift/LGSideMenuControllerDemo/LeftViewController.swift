...
class LeftViewController: UITableViewController {
    ...
    private let titlesArray = ["          SkyCandy Premium",
                               "",
                               "",
                               "Settings",
                               "Sun Times",
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.separatorView.isHidden = (indexPath.row <= 2 || indexPath.row == self.titlesArray.count-1 || indexPath.row == 8)
        cell.isUserInteractionEnabled = (indexPath.row != 1 && indexPath.row != 2 && indexPath.row != 8)
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == 0 {
            ...
            if(indexPath.row == 11){
               ...
               UIApplication.shared.openURL(URL(string: "https://appsto.re/ua/pTgR9.i")!)
